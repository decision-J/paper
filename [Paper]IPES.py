...
# ## until 01.22
# 
# ### animated3 구현 완료. 논문 리뷰하면서 simul등 구현해보기

# -------
# ## Animated3 구현 by IPES method

# In[21]:


get_ipython().system('pip install reggie')
...
import reggie as rg
rg.core.priors.Uniform(0.005, 0.015)
